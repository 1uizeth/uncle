...
export default function Page() {
  ...
  const handleVouchAction = (borrowerName: string, vouchedAmount: number, message: string) => {
  ...
  const handlePayment = () => {
    alert(`Payment of $${userLoanDetails.amount} processed! Your score might increase further. (Demo)`)
    setUserLoanDetails((prev) => ({ ...prev, score: prev.score + 20, fundedAmount: 0, vouchers: [] }))
    setCurrentScreen("LOAN_APPLICATION")
  }
  ...
  const simulatePartiallyFunded = () => {
    ...
    setUserLoanDetails({
      ...
      fundedAmount: 50,
      vouchers: [
        { name: "Sarah P.", amount: 50, message: "Hope this helps!", avatarUrl: "/placeholder.svg?height=24&width=24" },
      ],
      score: 50,
      repaymentDays: 3,
      paymentDueDate: dueDate,
  ...
  const simulateFullyFundedDueToday = () => {
    ...
    setUserLoanDetails({
      ...
      fundedAmount: 100,
      vouchers: [
        { name: "Alice B.", amount: 30, message: "Good luck!", avatarUrl: "/placeholder.svg?height=24&width=24" },
        { name: "Bob C.", amount: 50, message: "You got this!", avatarUrl: "/placeholder.svg?height=24&width=24" },
        { name: "Charlie D.", amount: 20, avatarUrl: "/placeholder.svg?height=24&width=24" },
      ],
      score: 100,
      repaymentDays: 3,
    ...
    return (
      <div className="p-4">
        ...
        <div className="mt-8 space-y-2">
          <button onClick={simulatePartiallyFunded} className="block w-full p-2 bg-yellow-200 rounded">
            Demo: Partially Funded Loan
          </button>
          <button onClick={simulateFullyFundedDueToday} className="block w-full p-2 bg-green-200 rounded">
